...
export function ResponseGray(props: {
  ...
  return (
    <button
      class="bg-z-body-selected z-field relative h-12 w-full cursor-pointer appearance-auto rounded border-transparent px-0 py-1 shadow-none"
      ref={(el) => {
        if (props.onClick) {
