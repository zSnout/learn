...
import { Write } from "@/el/Write"
import { Id } from "@/lib/id"
import { notNull, prayTruthy } from "@/lib/pray"
...
export default defineLayer({
  ...
  render({
        ...
        >
          ...
          >
            <ResponsesGrid class="grid-cols-4">
              <Button
                class="bg-red-300 text-red-900 hover:bg-red-400 dark:bg-red-800 dark:text-red-100 dark:hover:bg-red-700"
                rating={Rating.Again}
                label="Again"
                shortcut={{ key: "1" }}
              />
              ...
              <Button
                class="bg-[#ffcc91] text-yellow-900 hover:bg-yellow-400 dark:bg-yellow-800 dark:text-yellow-100 dark:hover:bg-yellow-700"
                rating={Rating.Hard}
                label="Hard"
                shortcut={{ key: "2" }}
              />
              ...
              <Button
                class="bg-green-300 text-green-900 hover:bg-green-400 dark:bg-green-800 dark:text-green-100 dark:hover:bg-green-700"
                rating={Rating.Good}
                label="Good"
                shortcut={{ key: "3" }}
              />
              ...
              <Button
                class="bg-blue-300 text-blue-900 hover:bg-blue-400 dark:bg-blue-800 dark:text-blue-100 dark:hover:bg-blue-700"
                rating={Rating.Easy}
                label="Easy"
                shortcut={{ key: "4" }}
              />
    ...
    function QuickAction(props: {
      ...
      return (
        <button
          class="z-field text-z hover:enabled:bg-z-body-selected mx-[calc(-0.5rem_-_1px)] flex items-center gap-2 border-transparent bg-transparent px-2 py-0.5 shadow-none transition"
    ...
    function NullCard() {
      return (
        <div class="flex w-full flex-1 flex-col items-center justify-center gap-8">
          <p class="text-8xl">🎉</p>
          <h1 class="text-z-heading text-center text-xl font-semibold">
